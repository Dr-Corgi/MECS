...
def batch_gumbel_max_sample(a, max_gumbel_noise = 1.0):
    ...
    return tf.argmax(tf.subtract(a, matrix_U), dimension = 1)
...
#        final_number = tf.argmax(tf.subtract(matrix_X, matrix_U), dimension = 1) #you want dimension = 1 because you are argmaxing across rows.
